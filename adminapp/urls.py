...
from adminapp.controllers import user, category, orders
...
urlpatterns = [
    ...
    # продукты
    path('orders/index/', orders.OrderListView.as_view(), name='orders'),
    path('orders/update/<int:pk>', orders.OrderUpdateView.as_view(), name='orders_update'),
]
